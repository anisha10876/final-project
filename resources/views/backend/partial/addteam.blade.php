...
@section('content')
    ...
    <h1>Add Team User</h1>
    <form  method="post" action="{{ route('addteamsubmit') }}" class="text-capitalize" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" name="designation" id="designation" placeholder="add designation" class="form-control">
        </div>
        <div class="form-group">
